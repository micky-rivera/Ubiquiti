  ...
  return (
    <>
        <div className='product-page__nav'>
            ...
            <svg onClick={handleClick} className='product-page__back-btn-svg' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='product-page__title'>{state.chosenProduct.name}</p>
        </div>
